...
output "instance_information" {
  value = [
    {
      public = [
        yandex_compute_instance.nat-instance.network_interface[0].nat_ip_address,
        yandex_compute_instance.nat-instance.network_interface[0].ip_address,
        #yandex_compute_instance.platform.name,
        #yandex_compute_instance.platform.fqdn,
      ]
      private = [
        yandex_compute_instance.private.network_interface[0].nat_ip_address,
